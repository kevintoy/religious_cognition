...
raw_data<-read.csv("~/explaining atheism/ariel_project/prolific_survey/merged_prolific_data_christian_first_person.csv",fileEncoding="utf8")
...
combined_long$Type <- recode(combined_long$Type, 
                             'Belief' = 'Belief Change (prolific Christian, 2nd person)',
                             'Behavior' = 'Behavior Change (prolific Christian, 2nd person)')
combined_long$Type <- factor(combined_long$Type, levels = c("Belief Change (prolific Christian, 2nd person)", "Behavior Change (prolific Christian, 2nd person)"))
