...
raw_data<-read.csv("~/explaining atheism/ariel_project/prolific_survey/merged_prolific_data_christian.csv",fileEncoding="utf8")
...
combined_long$Type <- recode(combined_long$Type, 
                             'Belief' = 'Belief Change (prolific Christian)',
                             'Behavior' = 'Behavior Change (prolific Christian)')
combined_long$Type <- factor(combined_long$Type, levels = c("Belief Change (prolific Christian)", "Behavior Change (prolific Christian)"))
